...
<nav class="navbar navbar-expand-md bg-primary navbar-dark "> 
  ...
  <div class="collapse navbar-collapse navbar-brand" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="<?php echo 'stuindex.php?temp='.md5('dashboard');  ?>">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="modal" data-target="#passwordrest"  >Password Reset</a>
      </li>
